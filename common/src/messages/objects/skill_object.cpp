...
void ibh::write_skill_object(rapidjson::Writer<rapidjson::StringBuffer> &writer, skill_object const &obj) {
...
bool ibh::read_skill_object_into_vector(rapidjson::Value const &value, vector<skill_object> &objs) {
