...
void ibh::write_account_object(rapidjson::Writer<rapidjson::StringBuffer> &writer, account_object const &obj) {
...
bool ibh::read_account_object_into_vector(rapidjson::Value const &value, vector<account_object> &objs) {
