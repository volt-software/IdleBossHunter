...
namespace ibh {
    struct generic_error_response : message {
        ...
        ~generic_error_response() noexcept override = default;

        [[nodiscard]]
        string serialize() const override;

        [[nodiscard]]
        static unique_ptr<generic_error_response> deserialize(rapidjson::Document const &d);
        ...
        inline static constexpr uint32_t type = 17;
    };
}
