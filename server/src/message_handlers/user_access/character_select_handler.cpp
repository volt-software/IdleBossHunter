...
#ifdef TEST_CODE
    template void handle_character_select<custom_server, custom_hdl>(custom_server *s, rapidjson::Document const &d, unique_ptr<database_transaction> const &transaction,
