...
template<typename pool_T, typename transaction_T>
unique_ptr<transaction_T> boss_stats_repository<pool_T, transaction_T>::create_transaction() {
    return _database_pool->create_transaction();
}

template<typename pool_T, typename transaction_T>
void boss_stats_repository<pool_T, transaction_T>::insert(db_boss_stat &stat, unique_ptr<transaction_T> const &transaction) const {
...
template<typename pool_T, typename transaction_T>
void boss_stats_repository<pool_T, transaction_T>::update(db_boss_stat const &stat, unique_ptr<transaction_T> const &transaction) const {
...
template<typename pool_T, typename transaction_T>
optional<db_boss_stat> boss_stats_repository<pool_T, transaction_T>::get(uint64_t id, unique_ptr<transaction_T> const &transaction) const {
...
template<typename pool_T, typename transaction_T>
vector<db_boss_stat> boss_stats_repository<pool_T, transaction_T>::get_by_boss_id(uint64_t boss_id, unique_ptr<transaction_T> const &transaction) const {
